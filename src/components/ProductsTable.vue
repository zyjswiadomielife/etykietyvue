<template>
  <div>
    ...
    <div v-else-if="!searchBarRef?.isScannerActive || store.showingSelected" class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <div class="p-4 bg-white dark:bg-gray-800 border">
      ...
      <table class="w-full text-sm text-left rtl:text-right border text-gray-500 dark:text-gray-400">
...
// Dodaj nową metodę do czyszczenia zaznaczonych
const clearSelected = () => {
